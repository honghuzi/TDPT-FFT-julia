...
export gaussfield, trapezoidalfield, cos2field, GetEleField, ItoE0, nt, dt, t, ele1, ele2, ele3
...
# τ = 0.5e-15/2.4189e-17
# f1 = cos2field(ItoE0(1.0e15), 1.26, 0.0, τ, 1τ/2)
# f2 = cos2field(ItoE0(1.0e15), 2.53, 0.0, τ, 4τ/2)
# f3 = cos2field(ItoE0(1.0e15)/10, 0.04, 0, 4τ, 5τ/2)

τ = 8e-15/2.4189e-17
f1 = cos2field(ItoE0(1.0e15), 1.6, 0.0, τ, 4τ/2)
f2 = cos2field(ItoE0(1.0e15), 1.68, 0.0, τ, 5τ/2)
f3 = cos2field(ItoE0(1.0e15)/10, 0.04, 0.0, 4τ, 5τ/2)

const tExtra = 0.0#100./0.3
const dt = 0.1
...
@. ele1 = GetEleField(f1, t) #+ GetEleField(f2, t)
# @. ele2 = GetEleField(f3, t)
tStart = f1.tm - f1.τ /2
tEnd = f1.tm + f1.τ /2

tStart3 = f3.tm - f3.τ /2
tEnd3 = f3.tm + f3.τ /2
@. ele2 = cos((t - f1.tm) * pi / f1.τ )^2 * (t > tStart) * (t < tEnd)
@. ele3 = cos((t - f3.tm) * pi / f3.τ )^2 * (t > tStart3) * (t < tEnd3)
